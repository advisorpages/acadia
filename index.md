...
### 1. [The First 5 Minutes]({{ '/pages/01-the-first-5-mins/' | relative_url }})
...
### 5. [Problems with the House]({{ '/pages/05-problems-with-the-house/' | relative-url }})
...
### 6. [30-Second Personal Story]({{ '/pages/06-30-sec-personal-story/' | relative_url }})
...
### 7. [How We Get Paid]({{ '/pages/07-how-we-get-paid/' | relative_url }})
...
### 8. [Closing Questions]({{ '/pages/08-closing-questions/' | relative_url }})
*Determining next steps*
- Identify their primary interest
- Guide toward appropriate action
- Qualify for plan or team opportunity

### 9. [Getting a Plan]({{ '/pages/08a-getting-a-plan/' | relative_url }})
...
### 10. [Making Extra Money]({{ '/pages/08b-making-extra-money/' | relative_url }})
