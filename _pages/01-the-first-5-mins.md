...
<div class="dialogue-container">
  <div class="dialogue-row">
    ...
    <div class="dialogue-column">Hey, thanks for meeting up. I really appreciate you taking the time.</div>
  </div>

  <div class="dialogue-row">
    <div class="speaker-column speaker-2">Speaker 2:</div>
    <div class="dialogue-column">Of course — happy to.</div>
  </div>

  <div class="dialogue-row">
    <div class="speaker-column speaker-1">Speaker 1:</div>
    <div class="dialogue-column">Before we get into anything, I just want to be clear — this isn't a sales meeting.</div>
  </div>
